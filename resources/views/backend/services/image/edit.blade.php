    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Edit Gambar Kategori Layanan</h3>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Gambar Kategori Layanan</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('image_category_services.update', $imageCategoryService->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select name="category_services_id" id="category_services_id" class="form-control @error('category_services_id') is-invalid @enderror" required>
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}" {{ $category->id == $imageCategoryService->category_services_id ? 'selected' : '' }}>{{ $category->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-group-default">
                                            ...
                                            @if ($imageCategoryService->image)
                                                <div class="mt-2">
                                                    <img src="{{ asset($imageCategoryService->image) }}" alt="Current Gallery Image" class="img-thumbnail" width="200">
                                                </div>
                                            @endif
